...
- **2-5 paragraphs**, each covering a distinct theme or segment of the
  conversation
...
- **No hallucinated links** — only include URLs for things actually discussed or
  directly referenced. If you can't find a canonical URL for something
  mentioned, omit it rather than guess.
- **Transcript and show notes stay in `tmp/`** — do not move, copy, or commit
  the VTT or show notes files.
